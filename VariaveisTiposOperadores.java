...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        float cotacaoDolar;
        double consumoMedio;
        boolean estaLogado; // lógicos verdadeiro/falso
        char genero; //uma letra só F/M 'aspas simples'
        ...
        /*  
            ...
            long 	64              -263 a 263 -1                                                   0L //letra que corresponde ao tipo
            float 	32            IEEE 754 ±1,40129846432481707e-45 a 3,40282346638528860e+38 	  0.0f //letra que corresponde ao tipo
            double 	64            IEEE 754 ±4,94065645841246544e-324 a 1,79769313486231570e+308   0.0d //letra que corresponde ao tipo
        */
        
        
        //Exemplos de tipos variáries não primitivas
        String nome; // "aspas duplas"
        Date dataNascimento;
